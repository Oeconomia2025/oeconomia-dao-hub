...
const PROTOCOLS: Protocol[] = [
  {
    ...
    milestones: [
      ...
      { title: "Docs link in sidebar (docs.oeconomia.io)", status: "done" },
      { title: "Ecosystem space with protocol links and contract addresses", status: "done" },
      { title: "Automated weekly devlog system with GitHub Pages", status: "done" },
      { title: "GitBook documentation deployed across all protocols", status: "done" },
      { title: "Monthly narrative reports for Medium", status: "done" },
  ...
  },
  {
    ...
    milestones: [
      ...
      { title: "Limit orders contract deployed and wired to frontend", status: "done" },
      { title: "Pool explorer with real on-chain data (replaced mock data)", status: "done" },
      { title: "Site rethemed with new color palette and gradient UI", status: "done" },
      { title: "Smart decimal formatting across all inputs", status: "done" },
      { title: "Cross-chain swap integration (LI.FI / Squid)", status: "upcoming" },
      { title: "Limit order executor bot for automated fills", status: "upcoming" },
      { title: "Deploy to Base mainnet", status: "upcoming" },
    ],
  },
  {
  ...
  },
  {
    ...
    milestones: [
      ...
      { title: "Alluria protocol contracts added to explorer constants", status: "done" },
      { title: "Filtered external transfers to Oeconomia-only events", status: "done" },
